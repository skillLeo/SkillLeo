...
<x-modals.edits.base-modal id="editProfileModal" title="Edit Profile" size="lg">
    <form id="profileForm" method="POST" action="{{ route('tenant.profile.update',$username) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="modal-section">
            ...
            <div class="form-group">
                ...
                <input type="url" name="linkedin" class="form-input"  value="{{ old('linkedin', $user->profile->social_links['linkedin'] ?? '') }}" placeholder="https://linkedin.com/in/yourprofile">
            </div>

            <div class="form-group">
                <label class="form-label">     <svg width="16" height="16" viewBox="0 0 24 24" fill="#1DA1F2" aria-hidden="true">
                    <path
                        d="M22.46 6c-.77.35-1.6.58-2.46.69.88-.53 1.56-1.37 1.88-2.38-.83.5-1.75.85-2.72 1.05C18.37 4.5 17.26 4 16 4c-2.35 0-4.27 1.92-4.27 4.29 0 .34.04.67.11.98C8.28 9.09 5.11 7.38 3 4.79c-.37.63-.58 1.37-.58 2.15 0 1.49.75 2.81 1.91 3.56-.71 0-1.37-.2-1.95-.5v.03c0 2.08 1.48 3.82 3.44 4.21a4.22 4.22 0 0 1-1.93.07 4.28 4.28 0 0 0 4 2.98 8.521 8.521 0 0 1-5.33 1.84c-.34 0-.68-.02-1.02-.06C3.44 20.29 5.7 21 8.12 21 16 21 20.33 14.46 20.33 8.79c0-.19 0-.37-.01-.56.84-.6 1.56-1.36 2.14-2.23z" />
                </svg>
                Twitter</label>
                <input type="url" name="twitter" class="form-input"  value="{{ old('twitter', $user->profile->social_links['twitter'] ?? '') }}" placeholder="https://twitter.com/yourhandle">
            </div>

            <div class="form-group">
                <label class="form-label">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="#333" aria-hidden="true">
                        <path
                     ...
                     GitHub</label>
                <input type="url" name="github" class="form-input" value="{{ old('github', $user->profile->social_links['github'] ?? '') }}"placeholder="https://github.com/username">
            </div>

            <div class="form-group">
                <label class="form-label">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="#FF5722" aria-hidden="true">
                        <path
                            d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" />
                    </svg>Website</label>
                <input type="url" name="website" class="form-input"     value="{{ old('website', $user->profile->social_links['website'] ?? '') }}" placeholder="https://example.com">
            </div>
        </div>
    </form>
