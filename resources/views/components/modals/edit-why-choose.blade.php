<x-modals.base-modal id="editWhyChooseModal" title="Why Choose Me" size="md">
    <form id="whyChooseForm" method="POST" action="#">
        @csrf
        @method('PUT')
        ...
        <div class="why-input-section">
            <div class="input-row">
                <textarea 
                    ...
                    maxlength="120"
                ></textarea>
                <button type="button" class="btn-add-reason" onclick="addReason()">
...
<style>
.why-input-section { margin-bottom: var(--space-lg); }
