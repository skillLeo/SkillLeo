    ...
    <nav class="top-nav">
        <div class="nav-inner">
            ...
            <div class="nav-row nav-row--top">
                <img class="nav-avatar" src="https://i.pravatar.cc/64?img=13" alt="Profile">
                <a class="brand" href="#">
                    <img class="brand-logo" src="{{asset('assets/images/logos/croped/logo_light.png')}}" 
                         alt="Brand" data-theme-src-light="                    <img class="brand-logo" src="{{asset('assets/images/logos/croped/logo_light.png')}}" 
"
                         data-theme-src-dark="                    <img class="brand-logo" src="{{asset('assets/images/logos/croped/logo_dark.png')}}" 
">
                </a>
    ...
    <div class="profile-dropdown" id="profileDropdown">
        <div class="profile-card">
            <img class="profile-avatar-mini" src="https://i.pravatar.cc/96?img=13" alt="Profile">
            <div class="profile-info">
                <div class="profile-name">Hassam Mehmood</div>
                <div class="profile-bio">Full-Stack Developer | AI & Chatbot Expert</div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Notifications dropdown
            notificationsBtn?.addEventListener('click', () => toggleDropdown(notificationsDropdown, notificationsBtn));
            notificationsBtnMobile?.addEventListener('click', () => toggleDropdown(notificationsDropdown, notificationsBtnMobile));

            // Messages dropdown
            messagesBtn?.addEventListener('click', () => toggleDropdown(messagesDropdown, messagesBtn));
            messagesBtnMobile?.addEventListener('click', () => toggleDropdown(messagesDropdown, messagesBtnMobile));

            // Profile dropdown
            navAvatars.forEach(avatar => {
                avatar.addEventListener('click', () => toggleDropdown(profileDropdown, avatar));
            });
            ...
            // Mark notification/message as read when clicked
