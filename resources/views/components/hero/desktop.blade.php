...
.about-row span{ padding: 0 !important; }
.about-row .ui-icon{ padding: 0 !important; margin-bottom: 10px !important;}
    </style>
    <div class="hr"></div>
    ...
    <div class="cta">
        <x-ui.button 
            ...
            class="btn-chat"
        >
            <x-ui.icon name="message" size="sm" class="color-card" />
            Chat!
        </x-ui.button>
    ...
    >
        ...
        <button class="edit-card icon-btn" aria-label="More options" style="  position: static !important; /* or relative/fixed/sticky */
">
