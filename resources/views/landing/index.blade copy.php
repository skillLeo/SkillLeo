        ...
        <div class="hero-container">
            ...
            <div class="auth-card">
                <div class="auth-header">
                    <h2>Get started with SkillLeo</h2>
                    <p>It's free for up to 5 projects - no credit card needed</p>
                </div>
                ...
                <div class="social-auth">
                    <button class="social-btn" onclick="window.location.href='{{ route('oauth.redirect', 'google') }}'">
                    ...
                    <button class="social-btn" onclick="window.location.href='{{ route('oauth.redirect', 'github') }}'">
