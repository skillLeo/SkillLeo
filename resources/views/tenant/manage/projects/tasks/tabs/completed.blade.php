{{-- resources/views/tenant/manage/projects/tasks/tabs/completed.blade.php --}}
...
@if($tasks->count() > 0)
    <div class="completion-stats-bar">
        <div class="completion-stat">
            <i class="fas fa-check-double"></i>
            <div class="completion-stat-content">
                <span class="completion-stat-value">{{ $tasks->count() }}</span>
        ...
        <div class="completion-stat">
            ...
            <div class="completion-stat-content">
                <span class="completion-stat-value">{{ $tasks->where('completed_at', '>=', now()->startOfWeek())->count() }}</span>
                <span class="completion-stat-label">This Week</span>
            </div>
        </div>
        <div class="completion-stat">
            <i class="fas fa-fire"></i>
            <div class="completion-stat-content">
                <span class="completion-stat-value">{{ $tasks->where('completed_at', '>=', now()->subDays(7))->count() }}</span>
                <span class="completion-stat-label">Last 7 Days</span>
            </div>
        </div>
    </div>
    ...
    <div class="tasks-grid-wrapper">
        @foreach($tasks->groupBy('project_id') as $projectId => $projectTasks)
            ...
            <div class="tasks-project-group completed-group">
                <!-- Project Header -->
                <div class="tasks-project-header">
                    ...
                    <div class="tasks-project-info">
                        ...
                        <span class="tasks-project-meta">
                            ...
                            {{ $projectTasks->count() }} completed tasks
                        </span>
                    </div>
...
@else
    <div class="project-empty-state">
        ...
        <h3 class="project-empty-state-title">No Completed Tasks Yet</h3>
        <p class="project-empty-state-desc">Completed tasks will appear here. Keep going!</p>
    </div>
@endif
...
.tasks-project-group.completed-group {
    background: var(--card);
