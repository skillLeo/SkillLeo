{{-- resources/views/tenant/manage/projects/tasks/tabs/active.blade.php --}}
            ...
            <div class="tasks-project-group">
                ...
                <div class="tasks-project-header">
                    ...
                    <div class="tasks-project-info">
                        ...
                        <span class="tasks-project-meta">{{ $projectTasks->count() }} active tasks</span>
                    </div>
                ...
                <div class="tasks-card-grid">
                    @foreach($projectTasks as $task)
                        @include('tenant.manage.projects.tasks.components.task-card-compact', [
                            'task' => $task,
                            'canEdit' => false, // Can't edit tasks assigned to me
                            'canDelete' => false,
                            'canComplete' => true,
                            'canPostpone' => true,
                        ])
...
@else
    <div class="project-empty-state">
        ...
        <h3 class="project-empty-state-title">All Caught Up!</h3>
        <p class="project-empty-state-desc">You don't have any active tasks right now.</p>
    </div>
@endif
